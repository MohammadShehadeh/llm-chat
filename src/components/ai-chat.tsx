      ...
      <form onSubmit={handleSubmit} className="group/composer w-full">
        ...
        <div
          className={cn(
            ...
            isExpanded
              ? "rounded-3xl grid grid-cols-[1fr] grid-rows-[auto_1fr_auto] [grid-template-areas:'header'_'primary'_'footer']"
              : "rounded-3xl grid grid-cols-[auto_1fr_auto] grid-rows-[auto_1fr_auto] [grid-template-areas:'header_header_header'_'leading_primary_trailing'_'._footer_.']",
          )}
        >
          <div
            className={cn(
